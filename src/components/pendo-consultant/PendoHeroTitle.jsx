...
import PendoHeroStamp from './PendoHeroStamp';
...
const PendoHeroTitle = ({ line1Ref, line2Ref, star1Ref, star2Ref, star3Ref }) => {
    ...
    stars.forEach((star, i) => {
      if (star) {
        ...
        gsap.to(star, {
          ...
          ease: 'back.out(2)',
          onComplete: () => {
            // Continuous floating animation after appearing
            gsap.to(star, {
              y: -floatDistances[i],
  ...
  return (
    <TitleWrapper>
      ...
      <Title>
        <TitleLine>
          <TitleText ref={line1Ref}>Freelance Pendo</TitleText>
        </TitleLine>
        <TitleLine>
          <TitleText ref={line2Ref} style={{ color: '#FF3863' }}>Consultant</TitleText>
        </TitleLine>
      </Title>
      <PendoHeroStamp />
    </TitleWrapper>
